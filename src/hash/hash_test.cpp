...
using hash_algorithms_t =
    std::variant<sha256_hash, sha224_hash, sha512_hash, sha512_224_hash,
                 sha512_256_hash, sha384_hash>;
...
std::array<testcase_t, 21> testcases{
    {{sha256_hash(),
      "",
     ...
     {sha512_256_hash(),
      "Even if I could be Shakespeare, I think I should still choose to be "
      "Faraday. - A. Huxley",
      {B{0xa7}, B{0xa3}, B{0x84}, B{0x60}, B{0x05}, B{0xf8}, B{0xa9}, B{0x93},
       B{0x5a}, B{0x0a}, B{0x2d}, B{0x43}, B{0xe7}, B{0xfd}, B{0x56}, B{0xd9},
       B{0x51}, B{0x32}, B{0xa9}, B{0xa3}, B{0x60}, B{0x9b}, B{0xf3}, B{0x29},
       B{0x6e}, B{0xf8}, B{0x0b}, B{0x82}, B{0x18}, B{0xac}, B{0xff}, B{0xa0}}},
     {sha384_hash(),
      "abcdefghij",
